...
insert into empresa (Telefone, NomeEmpresa, SenhaEmpresa, FotoEmpresa, CNPJ, taxaEmpresa) values ('5579998881750','Lunary', '123321', '', '99999999999999', 388.00);
...
insert produto(NomeProduto, PrecoProduto, CategoriaID, EmpresaID, DescricaoProduto, NutricaoProduto) values ('Batata Frita','14.90',1,1,'Batata frita ao oleo','Carboidratos e gorduras');
